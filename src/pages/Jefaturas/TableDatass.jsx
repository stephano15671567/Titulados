...
function TableData({ titulados }) {
  ...
  useEffect(() => {
    ...
    axios.get('https://apisst.administracionpublica-uv.cl/api/profesores/guias/')
      .then(response => {
    ...
    axios.get('https://apisst.administracionpublica-uv.cl/api/profesores/informantes/')
      .then(response => {
  ...
  const saveAssignments = async () => {
    const updatePromises = Object.entries(selections).map(([tituladoId, selection]) =>
      axios.post('https://apisst.administracionpublica-uv.cl/api/profesores/asignacion', {
        tituladoId,
